...
| `eec9f781d` | docs/local              | keep patch register aligned with local restart guardrail commit | low                                     | `git revert eec9f781d` |
| `ed3d4ab95` | docs/local incidents    | add incident register and gateway restart incident report       | low                                     | `git revert ed3d4ab95` |
